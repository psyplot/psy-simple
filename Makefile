...
lint/isort: ## check style with flake8
	isort --check psy_simple tests
lint/flake8: ## check style with flake8
	flake8 psy_simple tests
lint/black: ## check style with black
	black --check psy_simple tests
	blackdoc --check psy_simple tests
...
formatting:
	isort psy_simple tests
	black psy_simple tests
	blackdoc psy_simple tests

quick-test: ## run tests quickly with the default Python
	python -m pytest

pipenv-test: ## run tox
	pipenv run isort --check psy_simple
...
coverage: ## check code coverage quickly with the default Python
	python -m pytest --cov psy_simple --cov-report=html

...
.. psy-simple documentation master file
...
.. rubric:: Psyplot plugin for simple visualization tasks

.. warning::

    This page has been automatically generated as has not yet been reviewed by
    the authors of psy-simple!
    Stay tuned for updates and discuss with us at
    https://codebase.helmholtz.cloud/psyplot/psy-simple
...
The source code of psy-simple is licensed under
LGPL-3.0-only.

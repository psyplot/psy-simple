...
from psyplot_gui.compat.qtcompat import Qt, QTest, QtGui
...
class TitleFmtWidgetTest(bt.PsyPlotGuiTestCase):
    ...
    def test_instance(self):
        ...
        self.assertIsInstance(
            self.fmt_widget.fmt_widget, pswt.FontPropertiesWidget
        )
        self.fmt_widget.fmto = self.plotter.titleweight
        self.assertIsInstance(
            self.fmt_widget.fmt_widget, pswt.FontWeightWidget
        )
        self.fmt_widget.fmto = self.plotter.titlesize
        self.assertIsInstance(self.fmt_widget.fmt_widget, pswt.FontSizeWidget)
    ...
    def test_choose_font(self):
        ...
        self.assertEqual(
            properties,
            dict(family="Arial", size=24, weight="bold", style="italic"),
        )
